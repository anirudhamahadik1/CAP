					...
					<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						<div class="row">
							...
							<div class="col-md-2">
								...
								<input type="number" step=".01" name="sqft" placeholder="Sq. Ft." class="form-control" required>
							</div>
							<div class="col-md-2">
								<label>Size:</label>
...
?>
							...
							<div class="col-md-2">
								...
								<button type="submit" class="btn btn-primary" name="submit" value="addtempbill" style="display:none;">Add</button>
							</div>
						</div>
					</form>
					<br>
...
<?php
			$_totalAmount = 0;
			$_tax = 28;
			if(isset($_SESSION["_tempBill"])){
				foreach($_SESSION["_tempBill"] as $_k => $_v){
					$_totalAmount += $_v[7];
?>
							<tr>
								<td><?php echo $_v[0]; ?></td>
								...
								<td><?php echo $_v[6]; ?></td>
								<td><?php echo $_v[7]."/-"; ?></td>
								<td><a href="?submit=deltempbill&token=<?php echo $_k; ?>">Delete</a></td>
							</tr>
<?php
				}
			}
...
?>
						...
						<button type="submit" class="btn btn-primary" name="submit" value="submitbill">Submit Bill</button>
					</form>
<?php
		}
	}
